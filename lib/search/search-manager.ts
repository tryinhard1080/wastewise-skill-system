...
import type { SearchProvider, SearchResponse, SearchOptions, ProviderHealth } from './types'
...
export class SearchManager {
  ...
  async search(query: string, options: SearchOptions = {}): Promise<SearchResponse> {
    ...
    throw new Error(`Search failed: ${lastError?.message || 'All providers unavailable'}`)
  }
