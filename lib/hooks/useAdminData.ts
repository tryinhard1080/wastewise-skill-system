...
export function useUsers(filters?: {
  ...
  return useSWR(`/api/admin/users${queryString ? `?${queryString}` : ''}`, fetcher)
}
...
export function useJobs(filters?: {
  ...
  const queryString = params.toString()
  return useSWR(`/api/admin/jobs${queryString ? `?${queryString}` : ''}`, fetcher)
}
...
export function useAuditLogs(filters?: {
  ...
  const queryString = params.toString()
  return useSWR(`/api/admin/audit${queryString ? `?${queryString}` : ''}`, fetcher)
}
