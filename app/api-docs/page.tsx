    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="rounded-lg border border-red-200 bg-red-50 p-6 text-center">
          <h2 className="mb-2 text-xl font-bold text-red-800">Error Loading Documentation</h2>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto px-4 py-8">
          <h1 className="mb-2 text-4xl font-bold">WasteWise API Documentation</h1>
          <p className="text-blue-100">
            Interactive API explorer for the WasteWise waste management optimization platform
          </p>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-lg border bg-white p-4">
              ...
              <p className="text-sm text-gray-600">
                Login to get a JWT token, then click the "Authorize" button above and enter:
      ...
      <div className="border-t bg-gray-50 py-6">
        <div className="container mx-auto px-4 text-center text-sm text-gray-600">
          <p>
            WasteWise API v1.0.0 | Built with OpenAPI 3.0 | Generated with swagger-jsdoc
          </p>
          <p className="mt-2">
            <a href="https://wastewise.com/support" className="text-blue-600 hover:underline">
              Support
            </a>
            {' | '}
            <a href="https://wastewise.com/terms" className="text-blue-600 hover:underline">
              Terms of Service
            </a>
          </p>
        </div>
