...
import { useUsers, disableUser, enableUser, changeUserRole, deleteUser } from '@/lib/hooks/useAdminData'
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              and all associated data including projects and analysis results.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <Dialog open={!!roleUserId} onOpenChange={() => setRoleUserId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Select the new role for this user. Admin users have full access to the admin
              dashboard and can manage other users.
            </DialogDescription>
          </DialogHeader>
