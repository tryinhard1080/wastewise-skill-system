...
async function createInvoiceExcel() {
  ...
  // Save file
  const outputPath = path.join(process.cwd(), '__tests__', 'fixtures', 'sample-invoice.xlsx')
...
async function createHaulLogExcel() {
  ...
  // Add data rows
  const haulData = [
    { date: '2025-01-05', time: '08:15', container_type: 'COMPACTOR', tons: 6.8, location: 'Building A', notes: 'Normal pickup' },
    { date: '2025-01-08', time: '09:30', container_type: 'COMPACTOR', tons: 7.2, location: 'Building A', notes: '' },
    { date: '2025-01-12', time: '08:45', container_type: 'COMPACTOR', tons: 6.5, location: 'Building A', notes: 'Light load' },
    { date: '2025-01-15', time: '10:00', container_type: 'COMPACTOR', tons: 8.1, location: 'Building A', notes: '' },
    { date: '2025-01-19', time: '08:00', container_type: 'COMPACTOR', tons: 7.8, location: 'Building A', notes: 'Normal pickup' },
    { date: '2025-01-22', time: '09:15', container_type: 'COMPACTOR', tons: 6.9, location: 'Building A', notes: '' },
    { date: '2025-01-26', time: '08:30', container_type: 'COMPACTOR', tons: 7.5, location: 'Building A', notes: '' },
    { date: '2025-01-29', time: '09:45', container_type: 'COMPACTOR', tons: 8.3, location: 'Building A', notes: 'Heavy load' },
  ]
  ...
  // Save file
  const outputPath = path.join(process.cwd(), '__tests__', 'fixtures', 'sample-haullog.xlsx')
  await workbook.xlsx.writeFile(outputPath)
  console.log(`✓ Created: ${outputPath}`)
}
